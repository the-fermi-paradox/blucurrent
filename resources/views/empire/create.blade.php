...
<head>
    ...
    <title>Age of Empires II: Create</title>
    <!-- Font Awesome -->
    <link
        ...
        <div class="col-md-6">
            <form novalidate method="post" class="needs-validation">
                ...
                <div class="row mb-4 mt-4">
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            <input type="text" name="architecture" id="architecture" class="form-control" required/>
                ...
                <div class="row mb-4 mt-4">
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            <input type="text" name="continent" id="continent" class="form-control" required/>
                ...
                <div class="row mb-4 mt-4">
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            <input type="text" name="focus" id="focus" class="form-control" required/>
                ...
                <div class="row mb-4 mt-4">
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            <input type="text" name="unique_units" id="unique_units" class="form-control" required/>
                ...
                <div class="row mb-4 mt-4">
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            <input type="text" name="unique_technologies" id="unique_technologies" class="form-control" required/>
                ...
                <div class="row mb-4 mt-4">
                    <div class="col">
                        <div data-mdb-input-init class="form-outline">
                            <input type="text" name="unique_buildings" id="unique_buildings" class="form-control"/>
